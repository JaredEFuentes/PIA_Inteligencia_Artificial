...
class BlockState(object):
    ...
    def __init__(self, config, n, objects, parent=None, 
        ...
        self.objects = objects  # a string array which indicates in which 
                                # place in config is every cube
    ...
    def expand(self):
        ...
        for cube1 in self.config:
            ...
            if cube1[0] == -1:
                # if cube1 is not on table move cube1 on table  and create a 
                # child(new configuration of cubes)
                ...
                # if there are free cubes move cube1 over other free cube 
                # and create a child(new configuration of cubes)
